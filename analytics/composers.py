...
from src.helpers.common import get_last_monday, is_start_date_Monday, get_week_ending_date
from src.helpers.file_readers import get_local_data

def compose_weekly_data(start_date: str = get_last_monday(), 
                        file_type: str = SUPPORTED_FILE_TYPES["STOCK"], 
                        instr_name: str = "" ) -> pd.DataFrame: 
